        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-24 gap-12">
          <div className="max-w-xl space-y-6">
            ...
            <div className="flex items-end gap-4 border-b border-white/20 pb-4 pt-8 w-full max-w-md group focus-within:border-bronze transition-colors duration-500">
              ...
              />
              <button className="text-[10px] uppercase tracking-[0.25em] text-ash group-focus-within:text-bronze transition-colors hover:text-white">
                Subscribe
              </button>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                {['Contact Us', 'Shipping', 'Returns', 'Size Guide'].map((item) => (
                  <li key={item}>
                    <Link to="/contact" className="text-sm text-ash hover:text-white transition-colors hover-underline-animation">
                      {item}
                    </Link>
                  </li>
                ))}
