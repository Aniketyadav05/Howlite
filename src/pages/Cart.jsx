    ...
    <div className="min-h-screen bg-obsidian pt-24 md:pt-32 pb-20 px-6">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center bg-white/5 rounded-full border border-white/5 overflow-hidden">
                      <button
                        ...
                        className="p-3 text-ash hover:text-white hover:bg-white/5 transition-colors"
                      >
                        <Minus size={12} />
                      </button>
                      <span className="w-8 text-center text-xs font-medium text-bone">{item.quantity}</span>
                      <button
                        onClick={() => updateQuantity(item.id, item.quantity + 1)}
                        className="p-3 text-ash hover:text-white hover:bg-white/5 transition-colors"
                      >
                    ...
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      className="text-ash/50 hover:text-red-400 px-2 gap-2"
                    >
          ...
          {/* Checkout Summary */}
          <div className="lg:col-span-4 bg-[#151515] p-6 md:p-8 space-y-8 sticky top-32 border border-white/5 rounded-xl shadow-2xl h-fit">
            ...
            <Button
              ...
              variant="primary"
              className="w-full flex justify-center !text-black font-semibold py-4"
              icon={ArrowRight}
              iconPosition="right"
            >
              Proceed to Checkout
