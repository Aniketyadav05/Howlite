...
const Collections = () => {
  ...
  useEffect(() => {
    // Small delay to allow fade-in animation to trigger nicely
  ...
  return (
    <div className="min-h-screen bg-obsidian pt-32 pb-24 px-6">
      <div className="container mx-auto">
        ...
        {/* 1. Header Section */}
        <div className={`flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8 transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
